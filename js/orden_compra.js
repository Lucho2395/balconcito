...
function agregar_fc(){
    ...
    if(id_recurso !="" && detalle_compra_cantidad!=""&& detalle_compra_precio_compra!="" && recurso_val!="" && total!="" && recurso_sede_factor!="" && dato_cantidad!="" && recurso_sede_merma!="" &&detalle_compra_total_pedido!=""){
        contenido += recurso_val + "-.-." +id_recurso + "-.-."+recurso_sede_factor+"-.-."+ dato_cantidad+"-.-."+ detalle_compra_cantidad + "-.-."+detalle_compra_precio_compra+"-.-."+recurso_sede_merma +"-.-."+total+"-.-."+detalle_compra_total_pedido+"/./.";
        console.log(contenido);
        $("#contenido").val(contenido);
        //$("#total").val(total);
        //$("#suma_total").val(suma_total_);
