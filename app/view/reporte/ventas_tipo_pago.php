        ...
        <div class="container-fluid">
            ...
            <form method="post" action="<?= _SERVER_ ?>Reporte/ventas_tipo_pago">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-12 col-md-12 col-sm-12" style="text-align: center;">
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <a href="<?= _SERVER_ ; ?>index.php?c=Reporte&a=ventas_tipo_pago_pdf&id_tipo_pago=<?= $_POST['id_tipo_pago']?>&fecha_hoy=<?= $_POST['fecha_hoy']?>&fecha_fin=<?= $_POST['fecha_fin']?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</a>
                </div>
            </div>
        </div>
    </div>
