...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-6 col-md-6 col-xs-6"></div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3" style="display: none">
                                ...
                                <select onchange="recursos(this.value)" id="id_sucursal" class="form-control" name="id_sucursal">
                                    <option value="">Seleccione</option>
                                    <?php
                                            ...
                                            <td>
                                                <select class="form-control" name="id_recurso" id="id_recurso">
                                                    ...
                                                    foreach($recurso as $n){
                                                        ?>
                                                        <option value="<?php echo $n->id_recurso_sede;?>"><?php echo $n->recurso_nombre;?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
