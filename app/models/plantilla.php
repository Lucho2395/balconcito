...
class PDF_WriteTag extends FPDF
{
    ...
    function Header(){
        $this->Image(_SERVER_.'media/logo/logo_gaia.jpeg',20,5,33);
        $this->SetFont('Arial','',11);
        $this->Cell(170,2,$_SESSION["nombre_empresa"],0,1,'R');
        $this->Cell(170,10,$_SESSION["ruc"],0,0,'R');
        $this->Ln(23);
    }
    // Public Functions
...
class PDF_MC_Table extends FPDF
{
    ...
    //protected $aligns;
    function Header(){
        $this->Image(_SERVER_.'media/logo/logo_gaia.jpeg',15,10,35);
        $this->SetFont('Arial','',11);
        $this->Cell(170,2,(isset($_SESSION["nombre_empresa"]))?$_SESSION["nombre_empresa"]:'',0,1,'R');
        $this->Cell(170,10,(isset($_SESSION["ruc"]))?$_SESSION["ruc"]:'',0,0,'R');
        $this->Ln(15);
    }
...
class PDF_WriteTag_practicante extends FPDF
{
    protected $wLine; // Maximum width of the line
    protected $hLine; // Height of the line
    protected $Text; // Text to display
    ...
    protected $TagHref; // URL for a cell
    function Header(){
        $this->Image(_SERVER_.'styles/brunner/img/logo_brunner.png',15,10,50);
        /*$this->SetFont('Arial','',11);
        $this->Cell(170,2,$_SESSION["empresa"],0,1,'R');
        $this->Cell(170,10,$_SESSION["ruc"],0,0,'R');*/
        $this->Ln(15);
    }
    // Public Functions
